...
class OrgsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create org" do
    assert_difference('Org.count') do
      post orgs_url, params: { org: { bio: @org.bio, category: @org.category, fbID: @org.fbID, name: @org.name, photo_url: @org.photo_url, tagline: @org.tagline, website: @org.website } }
    end
  ...
  test "should update org" do
    patch org_url(@org), params: { org: { bio: @org.bio, category: @org.category, fbID: @org.fbID, name: @org.name, photo_url: @org.photo_url, tagline: @org.tagline, website: @org.website } }
